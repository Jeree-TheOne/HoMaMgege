    ...
    ~City()
    {
        ...
        void EnterTheCity(Hero hero) {
            ...
            switch (this->type) {
                case 0: {
                    cout
                            << "Слегка терясь в оживленных улицах,  вы выходите на главную площадь этого прекрасного города. \n";
                    cout
                            << "Дороги в этом городе были облагороженны вырезанным вручную камнем, который служил гарниром изысканным цветам богатых оттенков, стоявших в расписных горшках у двухэтажных дворцов, что прямо по улице создавали ряды, словно грядки на картине модерниста. \n";
                    cout
                            << "Вы не смогли не оценить ухоженности и благосостояния людей, которые, как бы намекали вам, что вы не из тех, кому дозволено отдыхать здесь\n";
                    cout << "Однако, несмотря на факты вашей неуместности," << this->name
                         << " принимает вас и дает возможность посетить лучшие заведения этой земли";
                    break;
                }
                case 1: {
                    cout
                            << "Этот город находится, возможно, на пике своего развития, въехав в него, вы понимаете, что вам следует остаться хотя бы на минуту дольше, чем запланированно \n";
                    cout << "Оказавшись на одном из мостов " << this->name
                         << "вам открывается вид плотного траффика улиц, уставших лиц рабочих и занятых дам, которые будто специально настолько фальшиво изображают работу \n";
                    cout
                            << "С каждой секундой становится яснее - городу с несломимой экономикой, армией и мудрым правителем вы не нужны, если не сможете купить здесь что-либо.";
                    cout
                            << "Почувствовав, что вы стоите на мосту уже лишний час, вы жалеете, что выбрали не тот жизненный путь";
                    break;
                }
                case 2: {
                    cout << "Неуспели вы въехать в " << this->name
                         << ", как встали в огромную очередь из других повозок купцов, которые приезжают сюда \n";
                    cout
                            << "Между каретами редко мельтешат краснолицие рабочие, невольно становившиеся целью ругательств кучеров \n";
                    cout
                            << "Вскоре вы останавливаетесь в центре города - Кучи строительных материалов, потных лиц в перемешку с крупными бочками заполоняли полудостроенные дома \n";
                    cout << "Очевидно, " << this->name
                         << " вскоре будет цвести и пахнуть, а пока он пыхтит и суетится - идеальное место для капиталовложения \n";
                    break;
                }
                case 3: {
                    cout << "Ничего особенного, " << this->name << " - самый обкновенный город из самых обычных \n";
                    cout
                            << "Здесь нет суеты, как в крупных городах, люди живут спокойной, честной жизнью, женщины прядут, а мужики напивыаются в кабаке \n";
                    cout
                            << "В основном, в этом городе преобладают рабочие - улицы не чистые, но и не грязные, стекла слегка желтоваты, а некоторые цветы вянут из-за плохой хозяйки \n";
                    cout << "Вас обдал жар обычности, как бы призывающий к тому, что ваше место здесь ";
                    break;
                }
                case 4: {
                    cout << " Оживленные улицы " << this->name
                         << "остались будто в прошлом - когда то по широким дорогам этого города шли непробойные вереницы торговцев со всего мира"
                         << " \n";
                    cout << "Одна эпидемия, другой неверный шаг правителя, третий - разбой посреди улицы и "
                         << this->name << " стоит забыть о процветающем будущем" << "\n";
                    cout
                            << "Люди уезжают из города, предприятия закрываются, а неудачные предпринематели - банкротятся. Не стоит здесь искать выгодных предложений \n";
                    cout
                            << "Случайный прохожий задел вас плечом, будто насильно вытолкнув вас из фантазий, намекая, что надо бежать из этого города, ни на секунду не сомневавшись \n";
                    break;
                }
                case 5: {
                    cout << "Вас встретили у ворот, " << this->name
                         << " старые солдаты, которым уже была положена счастливая пенсия в порядочном городе \n";
                    cout
                            << " Однако, им сейчас приходится охранять полуразрушенные стены старого замка, который не отпускает лишних рук \n";
                    cout
                            << " Город борется за существование, прилавки редких купцов полупусты, а некоторые окна заколочены. \n";
                    cout
                            << " Вас резко пронзил запах дохлой крысы - обед местного кошачьего населения, в перспективе становившееся людской платой за существование. \n";
                    break;
                }
                case 6: {
                    cout
                            << "Сперва вы подумали, что попали не туда куда вам нужно, однако люди, хватавшиеся за последние нити существования, своим "
                            << this->name << "им акцентом переубедил вас \n";
                    cout
                            << "Бывшие дома господ находятся в печальном состоянии - притоны и редкие торговцы заполонили их, будто крысы на палубе тонущего корабля \n";
                    cout
                            << "В разбитом городском колодце вы видите что-то похожее на скелет человека и мешочек с чем-то блестящим, потрогав карманы, вы решили держать руки в них напротяжении всего пребывания в городе \n";
                    cout << "Тем неменее суть вашего пребывания остается неизменной";
                    break;
                }
                case 7: {
                    cout << "Перешагивая через трупы жителей " << this->name
                         << "вы не совсем понимаете цель своего визита.  \n";
                    cout
                            << "Недавний рейд порешал почти все живое, раненые и скорбящие перебрались в редкие полуразрушенные здания, не преданные огню. \n";
                    cout << "Возможно, стоит проверить эти домики на наличие выгоды. \n";
                    break;
                }
            } // Истории городов
            cout << "\nВы решаете отправиться.. \n";
            int j = 0;
            // inc[0] - Таверна, inc[1] - Рынок, inc[2] - Лагерь наемников,
            // inc[3] - Башня мага, inc[4] - Магический колодец , inc[5] - Городская площадь,
            // inc[6] - Торговец побрякушками, inc[7] - Шатер предсказательницы.
            ...
            for (int i = 0; i < 7; i++) {
                switch (i) {
                    ...
                    case 4: {
                        if (inc[i] == true) {
                            x++;
                            cout << x << ") К странному колодцу.\n";
                        }
                        break;
                    }
                    case 5: {
                        x++;
                        cout << x << ") Зайти в инвентарь";
                    }
                    case 6 :
                        cout << ++x << ") Выйти из города. \n";
                        break;
                }
            }
            cin >> j;
            if (j > x + 1) goto povtor;
            if (j == x) hero.ViewInventory();
            x = 0;
            int y = 0;
            while (j != y){
                if (inc[x] == true) {
            ...
            if (x == 2) {
                Marketplace *marketplace = (Marketplace *) (&enterprises[x]);
                marketplace->EnterTheMarketPlace(hero);
                goto povtor;
            } else if (x == 1) {
                Tavern *tavern = (Tavern *) (&enterprises[x]);
                tavern->EnterTheTavern(hero);
                goto povtor;
            } else if (x == 4) {
                MagicTower *magicTower = (MagicTower *) (&enterprises[x]);
                magicTower->EnterTheMagicTower(hero);
                goto povtor;
            } else if (x == 3) {
                Mercenary *mercenary = (Mercenary *) (&enterprises[x]);
                mercenary->EnterTheMercenaryMarket(hero);
                goto povtor;
            } else if (x == 5) {
                MagicWell *magicWell = (MagicWell *) (&enterprises[x]);
                magicWell->EnterTheMagicWell(hero);
                goto povtor;
            }
...
private:
    ...
    int type; // Тип данжа(См ниже)
     vector<int> shagi; // <- Последовательность ходов в данже
...
public:
   ...
   Dungeon()
    ...
    {
        cout << "Вы входите в темный коридор, на стенах которого, застывшим Cumom написано " << this->name <<". \n";
        for (int i = 0; i<shagi.size(); i++)
        {
            switch (shagi[i])
            {
                case 9 :
                    {
                        if (shagi[i-1] == 9)
                            cout << "*Процесс передвижения по пустым проходам* \n";
                        else
                            cout << "Вы входите в пустой проход \n";
                    break;
                    }
                case 0:
                {
                    cout << "Сквозь кирпичи вы видите, как пыль оседшая от древних fat cocks осела на грунт \n ";
                    cout << "Яркое солнце озарило вас сквозь дыру в стене. \n";
                    cout << "1) Выйти из данжа \n";
                ...
                case 1:
                {
                    cout << "Проходя между множеством тоннелей, вы находите дыру в стене, за которой, судя по всему, находится секретная комната \n";
                    cout << "1) Исследовать комнату \n";
                    cout << "2) Продолжить путь \n";
                    int j = 0;
                    cin >> j;
                    if (j == 2)
                        i++;
                ...
                case 10:
                {
                    cout << "К вашему сожалению, вы ничего, кроме пару маленьких jabhronies не смогли найти в комнате \n";
                    cout << "Решивши не останавливаться на достигнутом, вы продалжаете путь \n";
                    break;
                }
                case 11:
                {
                ...
                case 13:
                {
                    ...
                    cout << "ВЫ УДАРИЛИСЬ МИЗЕНЦЕМ О СУНДУК В ТЕМНОЙ КОМНАТЕ. \n";
                    cout << "Открыв его, вы увидели виновника торжества  - " << equipment1.GetName() <<", а также" << equipment2.GetName() << " \n";
                    hero.Inventory.push_back(equipment1);
                    hero.Inventory.push_back(equipment2);
                    cout << "Положив награду куда надо, вы продолжаете путь \n";
                    break;
                }
                case 14 :
                {
                    cout << "Пройдя со своим отрядом в глубь комнаты, вы оступаетесь, слышите резкий хруст и свист.. \n";
                    cout << "Вероятно, это хрустели ваши войны, вы потеряли 75% здоровья всей своей армии";
                    for (Units a : hero.army)
                        a.SetHp(a.GetHP()-(a.GetHP()*75)/100);
                    break;
                }
                case 2:
                {
